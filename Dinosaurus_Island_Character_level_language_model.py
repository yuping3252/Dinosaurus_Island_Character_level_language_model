...
def model(data_x, ix_to_char, char_to_ix, num_iterations = 35000, n_a = 50, dino_names = 7, vocab_size = 27, verbose = False):
    ...
    # data_x is a list of words
    # examples is a list of words that without '\n'
    ...
    for j in range(num_iterations):
        ...
        single_example_chars = [ch for ch in examples[idx]]
        single_example_ix = [char_to_ix[ch] for ch in examples[idx]]
        X = [None] + [char_to_ix[ch] for ch in examples[idx]]     # X is a list of indices of a word
